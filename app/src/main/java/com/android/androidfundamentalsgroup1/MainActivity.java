...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void buttonOpenCodeChallangeCardView(View view) {
        Intent intent = new Intent(MainActivity.this, CodeChallangeCardView.class);
        startActivity(intent);
    }

    public void buttonOpenCodeChallangeAlerts(View view) {
        Intent intent = new Intent(MainActivity.this, CodeChallangeAlerts.class);
        startActivity(intent);
    }
}
